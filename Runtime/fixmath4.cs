...
namespace Paulsams.FixedPoint
{
    public partial struct fixmath
    {
        ...
        public static fp Sum(fp4 v) =>
            new fp(v.x.value + v.y.value + v.z.value + v.w.value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp4 Abs(fp4 v) =>
            new fp4(Abs(v.x), Abs(v.y), Abs(v.z), Abs(v.w));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp Dot(fp4 a, fp4 b) =>
            new(((a.x.value * b.x.value) >> fixlut.PRECISION) +
        ...
        public static fp4 Normalize(fp4 v) =>
            v == fp4.zero ? fp4.zero : v / Magnitude(v);
        ...
        public static fp4 Min(fp4 a, fp4 b) =>
            new fp4(Min(a.x, b.x), Min(a.y, b.y), Min(a.z, b.z), Min(a.w, b.w));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp4 Max(fp4 a, fp4 b) =>
            new fp4(Max(a.x, b.x), Max(a.y, b.y), Max(a.z, b.z), Max(a.w, b.w));
    }
}