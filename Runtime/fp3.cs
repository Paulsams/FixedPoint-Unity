...
namespace Paulsams.FixedPoint
{
    ...
    public struct fp3 : IEquatable<fp3>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator int3(fp3 value) =>
            new int3(value.x.AsInt, value.y.AsInt, value.z.AsInt);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator fp3(int3 value) =>
            new fp3(value.x, value.y, value.z);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector3Int(fp3 value) =>
            new Vector3Int(value.x.AsInt, value.y.AsInt, value.z.AsInt);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator fp3(Vector3Int value) =>
            new fp3(value.x, value.y, value.z);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3 ParseUnsafe(Vector3 value) =>
            new fp3(fp.ParseUnsafe(value.x), fp.ParseUnsafe(value.y), fp.ParseUnsafe(value.z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3 ParseUnsafe(float3 value) =>
            new fp3(fp.ParseUnsafe(value.x), fp.ParseUnsafe(value.y), fp.ParseUnsafe(value.z));
