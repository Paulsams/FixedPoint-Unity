...
namespace Paulsams.FixedPoint
{
    ...
    public struct Random
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int NextInt() =>
            (int)NextState() ^ -2147483648;

        /// <summary>Returns value in range [0, max]</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int NextInt(int max) =>
            (int)((NextState() * (ulong)max) >> 32);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp NextFp() =>
            new fp(NextInt(0, 65535));

        /// <summary>Returns vector with all components in range [0, 1]</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp2 NextFp2() =>
            new fp2(NextFp(), NextFp());

        /// <summary>Returns vector with all components in range [0, 1]</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp3 NextFp3() =>
            new fp3(NextFp(), NextFp(), NextFp());

        /// <summary>Returns vector with all components in range [0, 1]</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public fp4 NextFp4() =>
            new fp4(NextFp(), NextFp(), NextFp(), NextFp());
