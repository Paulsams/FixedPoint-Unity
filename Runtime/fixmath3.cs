...
namespace Paulsams.FixedPoint
{
    public partial struct fixmath
    {
        ...
        public static fp Sum(fp3 v) =>
            new fp(v.x.value + v.y.value + v.z.value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3 Abs(fp3 v) =>
            new fp3(Abs(v.x), Abs(v.y), Abs(v.z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp Dot(fp3 a, fp3 b) =>
            new fp(((a.x.value * b.x.value) >> fixlut.PRECISION) +
                   ((a.y.value * b.y.value) >> fixlut.PRECISION) +
                   ((a.z.value * b.z.value) >> fixlut.PRECISION));
        ...
        {
            t = Clamp01(t);
            return new fp3(LerpUnclamped(from.x, to.x, t), LerpUnclamped(from.y, to.y, t),
        ...
        public static fp AngleSigned(fp3 a, fp3 b, fp3 axis)
        {
            ...
            var sign =
                (((axis.x.value * num2) >> fixlut.PRECISION) +
        ...
        public static fp Radians(fp3 a, fp3 b) =>
            Acos(Clamp(Dot(Normalize(a), Normalize(b)), fp.minus_one, fp._1));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp RadiansSkipNormalize(fp3 a, fp3 b) =>
            Acos(Clamp(Dot(a, b), fp.minus_one, fp._1));
        ...
        public static fp3 Min(fp3 a, fp3 b) =>
            new fp3(Min(a.x, b.x), Min(a.y, b.y), Min(a.z, b.z));

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static fp3 Max(fp3 a, fp3 b) =>
            new fp3(Max(a.x, b.x), Max(a.y, b.y), Max(a.z, b.z));
